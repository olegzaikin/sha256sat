...
void sha256_transform(unsigned char data1[], unsigned int hash[8], unsigned int check[200])
{
...
int main() {
    ...
    sha256_transform(input1, hash1, check1);
    sha256_transform(input2, hash2, check2);
...
//    __CPROVER_assume(m_copy1[11] - m_copy2[11] == 0x27f42515);
    ...
    __CPROVER_assume(check1[0]-check2[0] == 1);
    __CPROVER_assume(check1[4]-check2[4] == 5);
